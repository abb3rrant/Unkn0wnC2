...
- **jitter_min_ms**: Minimum delay between bursts (default: 60000ms / 60s)
- **jitter_max_ms**: Maximum delay between bursts (default: 120000ms / 120s)
- **chunks_per_burst**: Number of chunks requested rapidly before pausing (default: 5)
- **burst_pause_ms**: Additional pause duration between bursts (default: 120000ms / 120s)
...
```json
{
  "stager": {
    "jitter_min_ms": 60000,
    "jitter_max_ms": 120000,
    "chunks_per_burst": 5,
    "burst_pause_ms": 120000,
...
**Jitter Strategy:**
- Within each burst: chunks requested rapidly (5 per burst by default)
- Between bursts: random delay of 60-120s + 120s pause (stealth-first timing)
