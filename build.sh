...
cd ..
install -m 755 update.sh /usr/bin/unkn0wnc2-update
echo -e "${GREEN}✓ Installed update script to /usr/bin/unkn0wnc2-update${NC}"
...
echo "  Update:       /usr/bin/unkn0wnc2-update"
